...
const DISPATCHES: DispatchDef[] = [
  {
    ...
    idField: "orderId",
    idPrefix: "ORD",
    buildPayload: (id) => ({ orderId: id, items: [{ sku: "ABC-123", qty: 2 }] }),
  },
  {
    kind: "putaway",
    title: "Container putaway",
    messageType: "CONTAINER_PUTAWAY",
    confirm: "PUTAWAY_CONFIRM",
    transport: "TCP",
    idField: "containerId",
    idPrefix: "CTN",
    buildPayload: (id) => ({ containerId: id, location: "A-01-03" }),
  },
  {
    kind: "cycle-count",
    title: "Cycle count",
    messageType: "CYCLE_COUNT_REQ",
    confirm: "CYCLE_COUNT_CONFIRM",
    transport: "FTP",
    idField: "countId",
    idPrefix: "CC",
    buildPayload: (id) => ({ countId: id, location: "B-02-07" }),
  },
];
